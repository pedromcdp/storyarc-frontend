...
export default function terms() {
  return (
    <MainLayout>
      <h1 className="py-5 text-2xl font-bold text-verde">Termos e Condições</h1>
      <p>
      ...
      <h1 className="py-2 font-bold">Contacte-nos</h1>
      <p className="pb-10">
        Se tiver alguma dúvida ou sugestão sobre os nossos Termos e Condições,
        não hesite em contactar-nos support@storyarc.pt.
      </p>
    </MainLayout>
  );
}
