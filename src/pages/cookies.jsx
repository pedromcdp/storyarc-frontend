...
export default function Cockies() {
  return (
    <MainLayout>
      <h1 className="py-5 text-2xl font-bold text-verde">Cookies</h1>
      <p>
      ...
      <h1 className="py-2 font-bold">Prestadores de Serviços</h1>
      <p>
      ...
      <h1 className="py-2 font-bold">Contact Us</h1>
      <p className="pb-10">
