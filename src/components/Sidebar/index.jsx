...
function Sidebar() {
  const { user } = useAuth();
  return (
    <div className="hidden flex-col justify-between py-3 px-4 max-w-[600px] h-screen bg-white rounded-r-3xl border-r drop-shadow-xl md:inline-flex xl:min-w-[300px]">
